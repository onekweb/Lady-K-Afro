...
--
-- Host: localhost
-- Generation Time: Mar 25, 2015 at 02:40 PM
...
--
-- Database: `ladykafro_com`
--

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_assets`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_assets` (
...
--
-- Dumping data for table `bak_cmaxl_assets`
--

INSERT INTO `bak_cmaxl_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `bak_cmaxl_associations`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_associations` (
...
--
-- Table structure for table `bak_cmaxl_banners`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_banners` (
...
--
-- Table structure for table `bak_cmaxl_banner_clients`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `bak_cmaxl_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_banner_tracks` (
...
--
-- Table structure for table `bak_cmaxl_categories`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_cmaxl_categories`
--

INSERT INTO `bak_cmaxl_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `bak_cmaxl_contact_details`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `bak_cmaxl_content`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_content` (
...
--
-- Table structure for table `bak_cmaxl_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_contentitem_tag_map` (
...
--
-- Table structure for table `bak_cmaxl_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_content_frontpage` (
...
--
-- Table structure for table `bak_cmaxl_content_rating`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_cmaxl_content_types`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_content_types` (
...
--
-- Dumping data for table `bak_cmaxl_content_types`
--

INSERT INTO `bak_cmaxl_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `bak_cmaxl_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_core_log_searches` (
...
--
-- Table structure for table `bak_cmaxl_extensions`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_extensions` (
...
--
-- Dumping data for table `bak_cmaxl_extensions`
--

INSERT INTO `bak_cmaxl_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `bak_cmaxl_finder_filters`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_filters` (
...
--
-- Table structure for table `bak_cmaxl_finder_links`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links` (
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms0` (
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_cmaxl_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `bak_cmaxl_finder_taxonomy`
--

INSERT INTO `bak_cmaxl_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `bak_cmaxl_finder_terms`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_terms` (
...
--
-- Table structure for table `bak_cmaxl_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `bak_cmaxl_finder_terms_common`
--

INSERT INTO `bak_cmaxl_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `bak_cmaxl_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_cmaxl_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `bak_cmaxl_finder_types`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_cmaxl_languages`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_languages` (
...
--
-- Dumping data for table `bak_cmaxl_languages`
--

INSERT INTO `bak_cmaxl_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_menu`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_cmaxl_menu`
--

INSERT INTO `bak_cmaxl_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `bak_cmaxl_menu_types`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_cmaxl_menu_types`
--

INSERT INTO `bak_cmaxl_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_messages`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_messages` (
...
--
-- Table structure for table `bak_cmaxl_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_messages_cfg` (
...
--
-- Table structure for table `bak_cmaxl_modules`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `bak_cmaxl_modules`
--

INSERT INTO `bak_cmaxl_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `bak_cmaxl_modules_menu`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_modules_menu` (
...
--
-- Dumping data for table `bak_cmaxl_modules_menu`
--

INSERT INTO `bak_cmaxl_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `bak_cmaxl_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_cmaxl_overrider`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_overrider` (
...
--
-- Table structure for table `bak_cmaxl_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_postinstall_messages` (
...
--
-- Dumping data for table `bak_cmaxl_postinstall_messages`
--

INSERT INTO `bak_cmaxl_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `bak_cmaxl_redirect_links`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_cmaxl_schemas`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_schemas` (
...
--
-- Dumping data for table `bak_cmaxl_schemas`
--

INSERT INTO `bak_cmaxl_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.3.6-2014-09-30');

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_session`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_session` (
...
--
-- Table structure for table `bak_cmaxl_tags`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `bak_cmaxl_tags`
--

INSERT INTO `bak_cmaxl_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_template_styles`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_cmaxl_template_styles`
--

INSERT INTO `bak_cmaxl_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `bak_cmaxl_ucm_base`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_ucm_base` (
...
--
-- Table structure for table `bak_cmaxl_ucm_content`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_ucm_content` (
...
--
-- Table structure for table `bak_cmaxl_ucm_history`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_ucm_history` (
...
--
-- Table structure for table `bak_cmaxl_updates`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_updates` (
...
--
-- Table structure for table `bak_cmaxl_update_sites`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_update_sites` (
...
--
-- Dumping data for table `bak_cmaxl_update_sites`
--

INSERT INTO `bak_cmaxl_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
...
--
-- Table structure for table `bak_cmaxl_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_update_sites_extensions` (
...
--
-- Dumping data for table `bak_cmaxl_update_sites_extensions`
--

INSERT INTO `bak_cmaxl_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `bak_cmaxl_usergroups`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `bak_cmaxl_usergroups`
--

INSERT INTO `bak_cmaxl_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `bak_cmaxl_users`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bak_cmaxl_users`
--

INSERT INTO `bak_cmaxl_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(602, 'Super User', 'admin', 'mario.onekanda@gmail.com', '$2y$10$eNpyVBsP639VSHn7T8v6hu2XZ9pH1EQnbprunmj.tsehi6utS2Vh2', 0, 1, '2015-02-23 14:17:20', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_user_keys`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_cmaxl_user_notes`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_cmaxl_user_profiles`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_user_profiles` (
...
--
-- Table structure for table `bak_cmaxl_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_user_usergroup_map` (
...
--
-- Dumping data for table `bak_cmaxl_user_usergroup_map`
--

INSERT INTO `bak_cmaxl_user_usergroup_map` (`user_id`, `group_id`) VALUES
(602, 8);

-- --------------------------------------------------------

--
-- Table structure for table `bak_cmaxl_viewlevels`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `bak_cmaxl_viewlevels`
--

INSERT INTO `bak_cmaxl_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `bak_cmaxl_weblinks`
--

CREATE TABLE IF NOT EXISTS `bak_cmaxl_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cmaxl_assets`
--

CREATE TABLE IF NOT EXISTS `cmaxl_assets` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set parent.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `cmaxl_assets`
--

INSERT INTO `cmaxl_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(27, 8, 18, 27, 2, 'com_content.category.2', 'Main articles', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(28, 3, 4, 5, 2, 'com_banners.category.3', 'Uncategorised', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(29, 7, 14, 15, 2, 'com_contact.category.4', 'Uncategorised', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
...
(54, 8, 28, 29, 2, 'com_content.category.8', 'Others', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(55, 27, 19, 20, 3, 'com_content.article.1', 'Home', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(56, 27, 21, 22, 3, 'com_content.article.2', 'About', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(57, 27, 23, 24, 3, 'com_content.article.3', 'Booking online', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(58, 27, 25, 26, 3, 'com_content.article.4', 'Galleri', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(59, 18, 80, 81, 2, 'com_modules.module.87', 'Social medias', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(60, 18, 82, 83, 2, 'com_modules.module.88', 'logo', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_associations`
--

CREATE TABLE IF NOT EXISTS `cmaxl_associations` (
  `id` int(11) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
  PRIMARY KEY (`context`,`id`),
...
--
-- Table structure for table `cmaxl_banners`
--

CREATE TABLE IF NOT EXISTS `cmaxl_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL DEFAULT '0',
  `type` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `cmaxl_banner_clients`
--

CREATE TABLE IF NOT EXISTS `cmaxl_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `contact` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `cmaxl_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `cmaxl_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) unsigned NOT NULL,
  `banner_id` int(10) unsigned NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cmaxl_categories`
--

CREATE TABLE IF NOT EXISTS `cmaxl_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `cmaxl_categories`
--

INSERT INTO `cmaxl_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 15, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Main articles', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 347, '2015-02-26 23:29:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 54, 1, 13, 14, 1, 'others', 'com_content', 'Others', 'others', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 347, '2015-02-26 23:29:11', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_contact_details`
--

CREATE TABLE IF NOT EXISTS `cmaxl_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `con_position` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `cmaxl_content`
--

CREATE TABLE IF NOT EXISTS `cmaxl_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `cmaxl_content`
--

INSERT INTO `cmaxl_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 55, 'Home', 'home', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>', '', 1, 2, '2015-02-26 23:29:52', 347, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2015-02-26 23:29:52', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 3, '', '', 1, 164, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 56, 'About', 'about', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>', '', 1, 2, '2015-02-26 23:29:52', 347, '', '2015-02-26 23:31:33', 347, 0, '0000-00-00 00:00:00', '2015-02-26 23:29:52', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 3, 2, '', '', 1, 50, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 57, 'Booking online', 'booking-online', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>', '', 1, 2, '2015-02-26 23:29:52', 347, '', '2015-02-26 23:32:23', 347, 0, '0000-00-00 00:00:00', '2015-02-26 23:29:52', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 3, 1, '', '', 1, 75, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 58, 'Galleri', 'galleri', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.</p>', '', 1, 2, '2015-02-26 23:29:52', 347, '', '2015-02-26 23:32:10', 347, 0, '0000-00-00 00:00:00', '2015-02-26 23:29:52', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 0, '', '', 1, 32, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `cmaxl_contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
  `core_content_id` int(10) unsigned NOT NULL COMMENT 'PK from the core content table',
  `content_item_id` int(11) NOT NULL COMMENT 'PK from the content type table',
  `tag_id` int(10) unsigned NOT NULL COMMENT 'PK from the tag table',
...
--
-- Table structure for table `cmaxl_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `cmaxl_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cmaxl_content_rating`
--

CREATE TABLE IF NOT EXISTS `cmaxl_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) unsigned NOT NULL DEFAULT '0',
  `rating_count` int(10) unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `cmaxl_content_types`
--

CREATE TABLE IF NOT EXISTS `cmaxl_content_types` (
  `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type_title` varchar(255) NOT NULL DEFAULT '',
  `type_alias` varchar(255) NOT NULL DEFAULT '',
  `table` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `cmaxl_content_types`
--

INSERT INTO `cmaxl_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
(1, 'Article', 'com_content.article', '{"special":{"dbtable":"#__content","key":"id","type":"Content","prefix":"JTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"}, "special":{"fulltext":"fulltext"}}', 'ContentHelperRoute::getArticleRoute', '{"formFile":"administrator\\/components\\/com_content\\/models\\/forms\\/article.xml", "hideFields":["asset_id","checked_out","checked_out_time","version"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"],"displayLookup":[{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"} ]}'),
(2, 'Weblink', 'com_weblinks.weblink', '{"special":{"dbtable":"#__weblinks","key":"id","type":"Weblink","prefix":"WeblinksTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"description", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{}}', 'WeblinksHelperRoute::getWeblinkRoute', '{"formFile":"administrator\\/components\\/com_weblinks\\/models\\/forms\\/weblink.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","featured","images"], "ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"], "convertToInt":["publish_up", "publish_down", "featured", "ordering"], "displayLookup":[{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"} ]}'),
(3, 'Contact', 'com_contact.contact', '{"special":{"dbtable":"#__contact_details","key":"id","type":"Contact","prefix":"ContactTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"address", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"image", "core_urls":"webpage", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{"con_position":"con_position","suburb":"suburb","state":"state","country":"country","postcode":"postcode","telephone":"telephone","fax":"fax","misc":"misc","email_to":"email_to","default_con":"default_con","user_id":"user_id","mobile":"mobile","sortname1":"sortname1","sortname2":"sortname2","sortname3":"sortname3"}}', 'ContactHelperRoute::getContactRoute', '{"formFile":"administrator\\/components\\/com_contact\\/models\\/forms\\/contact.xml","hideFields":["default_con","checked_out","checked_out_time","version","xreference"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"], "displayLookup":[ {"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"user_id","targetTable":"#__users","targetColumn":"id","displayColumn":"name"} ] }'),
(4, 'Newsfeed', 'com_newsfeeds.newsfeed', '{"special":{"dbtable":"#__newsfeeds","key":"id","type":"Newsfeed","prefix":"NewsfeedsTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"description", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"link", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{"numarticles":"numarticles","cache_time":"cache_time","rtl":"rtl"}}', 'NewsfeedsHelperRoute::getNewsfeedRoute', '{"formFile":"administrator\\/components\\/com_newsfeeds\\/models\\/forms\\/newsfeed.xml","hideFields":["asset_id","checked_out","checked_out_time","version"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"],"displayLookup":[{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"} ]}'),
...
--
-- Table structure for table `cmaxl_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `cmaxl_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cmaxl_extensions`
--

CREATE TABLE IF NOT EXISTS `cmaxl_extensions` (
  `extension_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
...
--
-- Dumping data for table `cmaxl_extensions`
--

INSERT INTO `cmaxl_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(1, 'com_mailto', 'component', 'com_mailto', '', 0, 1, 1, 1, '{"name":"com_mailto","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2014 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_MAILTO_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(2, 'com_wrapper', 'component', 'com_wrapper', '', 0, 1, 1, 1, '{"name":"com_wrapper","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2014 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_WRAPPER_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(3, 'com_admin', 'component', 'com_admin', '', 1, 1, 1, 1, '{"name":"com_admin","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2014 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_ADMIN_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(4, 'com_banners', 'component', 'com_banners', '', 1, 1, 1, 0, '{"name":"com_banners","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2014 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_BANNERS_XML_DESCRIPTION","group":""}', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":"","save_history":"1","history_limit":10}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(101, 'SimplePie', 'library', 'simplepie', '', 0, 1, 1, 1, '{"name":"SimplePie","type":"library","creationDate":"2004","author":"SimplePie","copyright":"Copyright (c) 2004-2009, Ryan Parman and Geoffrey Sneddon","authorEmail":"","authorUrl":"http:\\/\\/simplepie.org\\/","version":"1.2","description":"LIB_SIMPLEPIE_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(102, 'phputf8', 'library', 'phputf8', '', 0, 1, 1, 1, '{"name":"phputf8","type":"library","creationDate":"2006","author":"Harry Fuecks","copyright":"Copyright various authors","authorEmail":"hfuecks@gmail.com","authorUrl":"http:\\/\\/sourceforge.net\\/projects\\/phputf8","version":"0.5","description":"LIB_PHPUTF8_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"ba4b3662167220f40dfbebc664dcf1a3"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(104, 'IDNA Convert', 'library', 'idna_convert', '', 0, 1, 1, 1, '{"name":"IDNA Convert","type":"library","creationDate":"2004","author":"phlyLabs","copyright":"2004-2011 phlyLabs Berlin, http:\\/\\/phlylabs.de","authorEmail":"phlymail@phlylabs.de","authorUrl":"http:\\/\\/phlylabs.de","version":"0.8.0","description":"LIB_IDNA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(105, 'FOF', 'library', 'fof', '', 0, 1, 1, 1, '{"name":"FOF","type":"library","creationDate":"2014-03-09 12:54:48","author":"Nicholas K. Dionysopoulos \\/ Akeeba Ltd","copyright":"(C)2011-2014 Nicholas K. Dionysopoulos","authorEmail":"nicholas@akeebabackup.com","authorUrl":"https:\\/\\/www.akeebabackup.com","version":"2.2.1","description":"LIB_FOF_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(106, 'PHPass', 'library', 'phpass', '', 0, 1, 1, 1, '{"name":"PHPass","type":"library","creationDate":"2004-2006","author":"Solar Designer","copyright":"","authorEmail":"solar@openwall.com","authorUrl":"http:\\/\\/www.openwall.com\\/phpass\\/","version":"0.3","description":"LIB_PHPASS_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(200, 'mod_articles_archive', 'module', 'mod_articles_archive', '', 0, 1, 1, 0, '{"name":"mod_articles_archive","type":"module","creationDate":"July 2006","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"MOD_ARTICLES_ARCHIVE_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(601, 'English (United Kingdom)', 'language', 'en-GB', '', 1, 1, 1, 1, '{"name":"English (United Kingdom)","type":"language","creationDate":"2013-03-07","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.3.1","description":"en-GB administrator language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(700, 'files_joomla', 'file', 'joomla', '', 0, 1, 1, 1, '{"name":"files_joomla","type":"file","creationDate":"September 2014","author":"Joomla! Project","copyright":"(C) 2005 - 2014 Open Source Matters. All rights reserved","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.3.6","description":"FILES_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10000, 'Ladykafrotemplate', 'template', 'ladykafro', '', 0, 1, 1, 0, '{"name":"Ladykafrotemplate","type":"template","creationDate":"2015-02-23","author":"Mario Onekanda","copyright":"Mario Onekanda 2015","authorEmail":"","authorUrl":"http:www.onekweb.com","version":"1.0.0","description":"Lady K Afro Template","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_finder_filters`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_filters` (
  `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `state` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `cmaxl_finder_links`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `cmaxl_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cmaxl_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `state` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `cmaxl_finder_taxonomy`
--

INSERT INTO `cmaxl_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
  `node_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
...
--
-- Table structure for table `cmaxl_finder_terms`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_terms` (
  `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cmaxl_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL,
  KEY `idx_word_lang` (`term`,`language`),
  KEY `idx_lang` (`language`)
...
--
-- Dumping data for table `cmaxl_finder_terms_common`
--

INSERT INTO `cmaxl_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `cmaxl_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cmaxl_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `map_suffix` char(1) NOT NULL,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
...
--
-- Table structure for table `cmaxl_finder_types`
--

CREATE TABLE IF NOT EXISTS `cmaxl_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `mime` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `cmaxl_languages`
--

CREATE TABLE IF NOT EXISTS `cmaxl_languages` (
  `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `lang_code` char(7) NOT NULL,
  `title` varchar(50) NOT NULL,
  `title_native` varchar(50) NOT NULL,
...
--
-- Dumping data for table `cmaxl_languages`
--

INSERT INTO `cmaxl_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_menu`
--

CREATE TABLE IF NOT EXISTS `cmaxl_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to #__menu_types.menutype',
  `title` varchar(255) NOT NULL COMMENT 'The display title of the menu item.',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
...
--
-- Dumping data for table `cmaxl_menu`
--

INSERT INTO `cmaxl_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(22, 'menu', 'com_joomlaupdate', 'Joomla! Update', '', 'Joomla! Update', 'index.php?option=com_joomlaupdate', 'component', 1, 1, 1, 28, 0, '0000-00-00 00:00:00', 0, 0, 'class:joomlaupdate', 0, '', 49, 50, 0, '*', 1),
(23, 'main', 'com_tags', 'Tags', '', 'Tags', 'index.php?option=com_tags', 'component', 0, 1, 1, 29, 0, '0000-00-00 00:00:00', 0, 1, 'class:tags', 0, '', 51, 52, 0, '', 1),
(24, 'main', 'com_postinstall', 'Post-installation messages', '', 'Post-installation messages', 'index.php?option=com_postinstall', 'component', 0, 1, 1, 32, 0, '0000-00-00 00:00:00', 0, 1, 'class:postinstall', 0, '', 53, 54, 0, '*', 1),
...
(102, 'mainmenu', 'About', '2015-02-24-16-47-26', '', '2015-02-24-16-47-26', 'index.php?option=com_content&view=article&id=2', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 13, 14, 0, '*', 0),
(103, 'mainmenu', 'Galleri', '2015-02-24-16-47-27', '', '2015-02-24-16-47-27', 'index.php?option=com_content&view=article&id=4', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 17, 18, 0, '*', 0),
(104, 'mainmenu', 'Booking online', '2015-02-24-16-47-28', '', '2015-02-24-16-47-28', 'index.php?option=com_content&view=article&id=3', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 15, 16, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_menu_types`
--

CREATE TABLE IF NOT EXISTS `cmaxl_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL,
  `title` varchar(48) NOT NULL,
  `description` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `cmaxl_menu_types`
--

INSERT INTO `cmaxl_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_messages`
--

CREATE TABLE IF NOT EXISTS `cmaxl_messages` (
  `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id_from` int(10) unsigned NOT NULL DEFAULT '0',
  `user_id_to` int(10) unsigned NOT NULL DEFAULT '0',
  `folder_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cmaxl_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `cmaxl_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) NOT NULL DEFAULT '',
  `cfg_value` varchar(255) NOT NULL DEFAULT '',
  UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`)
...
--
-- Table structure for table `cmaxl_modules`
--

CREATE TABLE IF NOT EXISTS `cmaxl_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(100) NOT NULL DEFAULT '',
  `note` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `cmaxl_modules`
--

INSERT INTO `cmaxl_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Main Menu', '', '', 3, 'top', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"mainmenu","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(2, 40, 'Login', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 41, 'Popular Articles', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 42, 'Recently Added Articles', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(8, 43, 'Toolbar', '', '', 1, 'toolbar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_toolbar', 3, 1, '', 1, '*'),
...
(79, 52, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 53, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 59, 'Social medias', '', '<div class="top-socialmedias">Social medias</div>', 1, 'top', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 1, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":".top-socialmedias","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(88, 60, 'logo', '', '<div class="logo">\r\n<p><a href="#/">Lady K</a></p>\r\n</div>', 3, 'top', 347, '2015-03-25 13:29:43', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":".logo","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":".logo","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_modules_menu`
--

CREATE TABLE IF NOT EXISTS `cmaxl_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cmaxl_modules_menu`
--

INSERT INTO `cmaxl_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `cmaxl_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `cmaxl_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `cmaxl_overrider`
--

CREATE TABLE IF NOT EXISTS `cmaxl_overrider` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) NOT NULL,
  `string` text NOT NULL,
  `file` varchar(255) NOT NULL,
...
--
-- Table structure for table `cmaxl_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `cmaxl_postinstall_messages` (
  `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `extension_id` bigint(20) NOT NULL DEFAULT '700' COMMENT 'FK to #__extensions',
  `title_key` varchar(255) NOT NULL DEFAULT '' COMMENT 'Lang key for the title',
  `description_key` varchar(255) NOT NULL DEFAULT '' COMMENT 'Lang key for description',
...
--
-- Dumping data for table `cmaxl_postinstall_messages`
--

INSERT INTO `cmaxl_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
(1, 700, 'PLG_TWOFACTORAUTH_TOTP_POSTINSTALL_TITLE', 'PLG_TWOFACTORAUTH_TOTP_POSTINSTALL_BODY', 'PLG_TWOFACTORAUTH_TOTP_POSTINSTALL_ACTION', 'plg_twofactorauth_totp', 1, 'action', 'site://plugins/twofactorauth/totp/postinstall/actions.php', 'twofactorauth_postinstall_action', 'site://plugins/twofactorauth/totp/postinstall/actions.php', 'twofactorauth_postinstall_condition', '3.2.0', 1),
(2, 700, 'COM_CPANEL_MSG_EACCELERATOR_TITLE', 'COM_CPANEL_MSG_EACCELERATOR_BODY', 'COM_CPANEL_MSG_EACCELERATOR_BUTTON', 'com_cpanel', 1, 'action', 'admin://components/com_admin/postinstall/eaccelerator.php', 'admin_postinstall_eaccelerator_action', 'admin://components/com_admin/postinstall/eaccelerator.php', 'admin_postinstall_eaccelerator_condition', '3.2.0', 1),
(3, 700, 'COM_CPANEL_WELCOME_BEGINNERS_TITLE', 'COM_CPANEL_WELCOME_BEGINNERS_MESSAGE', '', 'com_cpanel', 1, 'message', '', '', '', '', '3.2.0', 1),
(4, 700, 'COM_CPANEL_MSG_PHPVERSION_TITLE', 'COM_CPANEL_MSG_PHPVERSION_BODY', '', 'com_cpanel', 1, 'message', '', '', 'admin://components/com_admin/postinstall/phpversion.php', 'admin_postinstall_phpversion_condition', '3.2.2', 1);
...
--
-- Table structure for table `cmaxl_redirect_links`
--

CREATE TABLE IF NOT EXISTS `cmaxl_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(255) NOT NULL,
  `new_url` varchar(255) NOT NULL,
  `referer` varchar(150) NOT NULL,
...
--
-- Table structure for table `cmaxl_schemas`
--

CREATE TABLE IF NOT EXISTS `cmaxl_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cmaxl_schemas`
--

INSERT INTO `cmaxl_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.3.6-2014-09-30');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_session`
--

CREATE TABLE IF NOT EXISTS `cmaxl_session` (
  `session_id` varchar(200) NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `guest` tinyint(4) unsigned DEFAULT '1',
  `time` varchar(14) DEFAULT '',
...
--
-- Dumping data for table `cmaxl_session`
--

INSERT INTO `cmaxl_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('3mtcc82s8ousu4qgkhtft6gso5', 0, 1, '1427290788', '__default|a:7:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1427290787;s:18:"session.timer.last";i:1427290787;s:17:"session.timer.now";i:1427290787;s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:31.0) Gecko/20100101 Firefox/31.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('40gdhvntrua9vtm74kiu7jb2l0', 0, 1, '1427290699', '__default|a:7:{s:15:"session.counter";i:83;s:19:"session.timer.start";i:1427286304;s:18:"session.timer.last";i:1427290693;s:17:"session.timer.now";i:1427290699;s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:31.0) Gecko/20100101 Firefox/31.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('8ovic1qrh90ekv7rl90u9nu1b5', 0, 1, '1427290787', '__default|a:7:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1427290787;s:18:"session.timer.last";i:1427290787;s:17:"session.timer.now";i:1427290787;s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:31.0) Gecko/20100101 Firefox/31.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('ftk86hl3rpv6b6pnlotn4hu4p7', 1, 0, '1427290183', '__default|a:8:{s:15:"session.counter";i:84;s:19:"session.timer.start";i:1427286390;s:18:"session.timer.last";i:1427290182;s:17:"session.timer.now";i:1427290183;s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:31.0) Gecko/20100101 Firefox/31.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":4:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:11:"com_modules";O:8:"stdClass":3:{s:7:"modules";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":8:{s:18:"client_id_previous";i:0;s:6:"search";s:4:"logo";s:6:"access";i:0;s:5:"state";s:0:"";s:8:"position";s:0:"";s:6:"module";s:0:"";s:9:"client_id";i:0;s:8:"language";s:0:"";}s:8:"ordercol";s:8:"position";s:9:"orderdirn";s:3:"asc";s:10:"limitstart";i:0;}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:1:{i:0;i:88;}s:4:"data";N;}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:20;}}}}s:4:"user";O:5:"JUser":27:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"347";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:24:"mario.onekanda@gmail.com";s:8:"password";s:60:"$2y$10$gIH4UDz1LdsdGxeg5LsYVuOYSYJ0NM2bu4MpG0NNCaYD8qHr6JVHa";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-02-23 14:22:40";s:13:"lastvisitDate";s:19:"2015-03-02 15:46:57";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"4b63791e17260caec30eb777dbe40a86";}', 347, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_tags`
--

CREATE TABLE IF NOT EXISTS `cmaxl_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `cmaxl_tags`
--

INSERT INTO `cmaxl_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_template_styles`
--

CREATE TABLE IF NOT EXISTS `cmaxl_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `home` char(7) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `cmaxl_template_styles`
--

INSERT INTO `cmaxl_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'ladykafro', 0, '1', 'Ladykafrotemplate - Default', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_ucm_base`
--

CREATE TABLE IF NOT EXISTS `cmaxl_ucm_base` (
  `ucm_id` int(10) unsigned NOT NULL,
  `ucm_item_id` int(10) NOT NULL,
  `ucm_type_id` int(11) NOT NULL,
  `ucm_language_id` int(11) NOT NULL,
...
--
-- Table structure for table `cmaxl_ucm_content`
--

CREATE TABLE IF NOT EXISTS `cmaxl_ucm_content` (
  `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `core_type_alias` varchar(255) NOT NULL DEFAULT '' COMMENT 'FK to the content types table',
  `core_title` varchar(255) NOT NULL,
  `core_alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `cmaxl_ucm_history`
--

CREATE TABLE IF NOT EXISTS `cmaxl_ucm_history` (
  `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ucm_item_id` int(10) unsigned NOT NULL,
  `ucm_type_id` int(10) unsigned NOT NULL,
  `version_note` varchar(255) NOT NULL DEFAULT '' COMMENT 'Optional version name',
...
--
-- Dumping data for table `cmaxl_ucm_history`
--

INSERT INTO `cmaxl_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 2, 6, '', '2015-02-26 23:29:00', 347, 576, 'af607b9929c0ceb3e982995dfad2d34a45efbaf8', '{"id":2,"asset_id":"27","parent_id":"1","lft":"1","rgt":"2","level":"1","path":"uncategorised","extension":"com_content","title":"Main articles","alias":"uncategorised","note":"","description":"","published":"1","checked_out":"347","checked_out_time":"2015-02-26 23:28:46","access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"42","created_time":"2011-01-01 00:00:01","modified_user_id":"347","modified_time":"2015-02-26 23:29:00","hits":"0","language":"*","version":"1"}', 0),
(2, 8, 6, '', '2015-02-26 23:29:11', 347, 513, '542b82d9be4065a56ae373fb03ddc899d902fc13', '{"id":8,"asset_id":54,"parent_id":"1","lft":"13","rgt":14,"level":1,"path":null,"extension":"com_content","title":"Others","alias":"others","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"347","created_time":"2015-02-26 23:29:11","modified_user_id":null,"modified_time":null,"hits":"0","language":"*","version":null}', 0),
(3, 1, 1, '', '2015-02-26 23:29:52', 347, 3641, '8d63f7d2866f6fafc5e479f3aae2a3c1699aac7e', '{"id":1,"asset_id":55,"title":"Home","alias":"home","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-02-26 23:29:52","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(4, 2, 1, '', '2015-02-26 23:29:56', 347, 3628, '876ac4f0073194ed00747783b6be49a54eb6311f', '{"id":2,"asset_id":56,"title":"Home (2)","alias":"home-2","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":0,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-02-26 23:29:52","publish_down":"","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(5, 2, 1, '', '2015-02-26 23:31:16', 347, 3682, 'ee4fe575c4df39340aaf5e8ebf7c3a09a94d17b4', '{"id":2,"asset_id":"56","title":"About","alias":"home-2","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:31:16","modified_by":"347","checked_out":"347","checked_out_time":"2015-02-26 23:29:56","publish_up":"2015-02-26 23:29:52","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(6, 2, 1, '', '2015-02-26 23:31:33', 347, 3681, '5c887c32ae904e5524384bbb78eff09de6383030', '{"id":2,"asset_id":"56","title":"About","alias":"about","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:31:33","modified_by":"347","checked_out":"347","checked_out_time":"2015-02-26 23:31:16","publish_up":"2015-02-26 23:29:52","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(7, 3, 1, '', '2015-02-26 23:31:37', 347, 3649, 'a8f2774145c1f02bb6957bde267bc9ee0056f121', '{"id":3,"asset_id":57,"title":"About (2)","alias":"about-2","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":0,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:31:33","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-02-26 23:29:52","publish_down":"","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(8, 3, 1, '', '2015-02-26 23:31:48', 347, 3677, '690346fbc5f8c2752ca8441986f8635f1e5ef206', '{"id":3,"asset_id":"57","title":"Boo","alias":"boo","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:31:48","modified_by":"347","checked_out":"347","checked_out_time":"2015-02-26 23:31:37","publish_up":"2015-02-26 23:29:52","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(9, 4, 1, '', '2015-02-26 23:32:04', 347, 3647, 'c6530d8eb2ad8282116d281fba0faff0f82fe88d', '{"id":4,"asset_id":58,"title":"Galleri","alias":"galleri","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":0,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:31:48","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-02-26 23:29:52","publish_down":"","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(10, 4, 1, '', '2015-02-26 23:32:10', 347, 3685, '4a0e2d42d318d7e31e0da4dd0566789ec53361d4', '{"id":4,"asset_id":"58","title":"Galleri","alias":"galleri","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:32:10","modified_by":"347","checked_out":"347","checked_out_time":"2015-02-26 23:32:04","publish_up":"2015-02-26 23:29:52","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(11, 3, 1, '', '2015-02-26 23:32:23', 347, 3699, '0919d9eb9a1290ba4c172ec0dacf4cf9fbc992cd', '{"id":3,"asset_id":"57","title":"Booking online","alias":"booking-online","introtext":"<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit sapien at ultrices tristique. Etiam arcu diam, euismod sit amet suscipit ac, tincidunt vel est. Nulla semper sodales convallis. Donec commodo purus id velit blandit, sed feugiat nisl elementum. Nam elementum porta felis id congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque efficitur pretium eleifend. Integer non sollicitudin justo, vel vestibulum sapien. Aliquam et ipsum sed nisi semper dapibus. Quisque erat nunc, lobortis non commodo nec, faucibus a felis. Cras tempor feugiat cursus. Curabitur nunc risus, pharetra sed velit et, efficitur semper eros. Fusce felis ipsum, fringilla eu euismod maximus, posuere eu erat. Nullam sollicitudin, justo quis aliquet venenatis, eros enim lacinia odio, at lacinia risus erat a justo. Nunc purus urna, iaculis in velit eu, volutpat faucibus ante. Suspendisse consectetur est porta ex commodo, ut consequat ante pulvinar.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-26 23:29:52","created_by":"347","created_by_alias":"","modified":"2015-02-26 23:32:23","modified_by":"347","checked_out":"347","checked_out_time":"2015-02-26 23:32:14","publish_up":"2015-02-26 23:29:52","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_updates`
--

CREATE TABLE IF NOT EXISTS `cmaxl_updates` (
  `update_id` int(11) NOT NULL AUTO_INCREMENT,
  `update_site_id` int(11) DEFAULT '0',
  `extension_id` int(11) DEFAULT '0',
  `name` varchar(100) DEFAULT '',
  ...
  `extra_query` varchar(1000) DEFAULT '',
  PRIMARY KEY (`update_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Available Updates' AUTO_INCREMENT=25 ;

--
-- Dumping data for table `cmaxl_updates`
--

INSERT INTO `cmaxl_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(2, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(3, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.4.0.2', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(4, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.4.1', '', 'http://update.joomla.org/core/sts/extension_sts.xml', '', ''),
(5, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(6, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(7, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.3.3.15', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(8, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(9, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(10, 3, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(11, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(12, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(13, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(14, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(15, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(16, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(17, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.3.0.2', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(18, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(19, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(20, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(21, 3, 0, 'EnglishCA', '', 'pkg_en-CA', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(22, 3, 0, 'FrenchCA', '', 'pkg_fr-CA', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(23, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
(24, 3, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/si-LK_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_update_sites`
--

CREATE TABLE IF NOT EXISTS `cmaxl_update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` text NOT NULL,
...
--
-- Dumping data for table `cmaxl_update_sites`
--

INSERT INTO `cmaxl_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1427286397, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1427286397, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1427286395, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1427286395, '');

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `cmaxl_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';
...
--
-- Dumping data for table `cmaxl_update_sites_extensions`
--

INSERT INTO `cmaxl_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `cmaxl_usergroups`
--

CREATE TABLE IF NOT EXISTS `cmaxl_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Adjacency List Reference Id',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `cmaxl_usergroups`
--

INSERT INTO `cmaxl_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `cmaxl_users`
--

CREATE TABLE IF NOT EXISTS `cmaxl_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `username` varchar(150) NOT NULL DEFAULT '',
  `email` varchar(100) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `cmaxl_users`
--

INSERT INTO `cmaxl_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(347, 'Super User', 'admin', 'mario.onekanda@gmail.com', '$2y$10$gIH4UDz1LdsdGxeg5LsYVuOYSYJ0NM2bu4MpG0NNCaYD8qHr6JVHa', 0, 1, '2015-02-23 14:22:40', '2015-03-25 12:26:33', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_user_keys`
--

CREATE TABLE IF NOT EXISTS `cmaxl_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) NOT NULL,
  `token` varchar(255) NOT NULL,
  `series` varchar(255) NOT NULL,
...
--
-- Table structure for table `cmaxl_user_notes`
--

CREATE TABLE IF NOT EXISTS `cmaxl_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) NOT NULL DEFAULT '',
...
--
-- Table structure for table `cmaxl_user_profiles`
--

CREATE TABLE IF NOT EXISTS `cmaxl_user_profiles` (
  `user_id` int(11) NOT NULL,
  `profile_key` varchar(100) NOT NULL,
  `profile_value` text NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cmaxl_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `cmaxl_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cmaxl_user_usergroup_map`
--

INSERT INTO `cmaxl_user_usergroup_map` (`user_id`, `group_id`) VALUES
(347, 8);

-- --------------------------------------------------------

--
-- Table structure for table `cmaxl_viewlevels`
--

CREATE TABLE IF NOT EXISTS `cmaxl_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `cmaxl_viewlevels`
--

INSERT INTO `cmaxl_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
(2, 'Registered', 1, '[6,2,8]'),
(3, 'Special', 2, '[6,3,8]'),
(5, 'Guest', 0, '[9]'),
...
--
-- Table structure for table `cmaxl_weblinks`
--

CREATE TABLE IF NOT EXISTS `cmaxl_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
